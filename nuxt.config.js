  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid:'og:description',name:'og:description', property: 'og:description',content: 'محيط - اكتشف الجديد و أفضل المقالات ومقاطع الفيديو'},
      ...
      { hid:'twitter:description',name:'twitter:description',content: 'محيط - اكتشف الجديد و أفضل المقالات ومقاطع الفيديو'},
