  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'محيط - اكتشف أحدث و أفضل المقالات ومقاطع الفيديو و الأخبار عن التكنولوجيا، الفن، التلفزيون، الأعمال ، الترفيه ، والمزيد' },
      ...
      { hid:'og:description',name:'og:description', property: 'og:description',content: 'محيط - اكتشف أحدث و أفضل المقالات ومقاطع الفيديو و الأخبار عن التكنولوجيا، الفن، التلفزيون، الأعمال ، الترفيه ، والمزيد'},
      ...
      { hid:'twitter:card',name:'twitter:card', content:'https://mo7eet.com/logo.png'},
      { hid:'twitter:title',name:'twitter:title', content:'محيط'},
      { hid:'twitter:description',name:'twitter:description',content: 'محيط - اكتشف أحدث و أفضل المقالات ومقاطع الفيديو و الأخبار عن التكنولوجيا، الفن، التلفزيون، الأعمال ، الترفيه ، والمزيد'},
