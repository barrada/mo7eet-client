...
export default{
	...
	async asyncData({ $axios,query }) {
			...
			const data= await $axios.$get('https://mo7eet-server.herokuapp.com/api/posts/movies')
...
methods:{
	...
	infiniteHandler($state){
		this.$axios.$get('https://mo7eet-server.herokuapp.com/api/posts/movies',{params:{page:this.page}}).then((response=>{
